...
* [`0a196c0`](https://github.com/spencerbeggs/vitest-agent-reporter/commit/0a196c04f78a84eb31d69d09156d014f9433ed73) Introduces the 2.0 data layer: XDG-based DB path resolution, 41-table SQLite schema, session/turn logging, TDD lifecycle tracking, and failure signature persistence.
