...
import { VitestAgentReporterConfig } from "./Config.js";

const decode = (input: unknown) => Effect.runPromise(Schema.decodeUnknown(VitestAgentReporterConfig)(input));

describe("VitestAgentReporterConfig", () => {
