...
/**
 * Schema for the optional `vitest-agent-reporter.config.toml` file.
 *
 ...
 *   database (e.g. project-local `.vitest-agent-reporter/`) instead of the
 ...
 */
export class VitestAgentReporterConfig extends Schema.Class<VitestAgentReporterConfig>("VitestAgentReporterConfig")({
